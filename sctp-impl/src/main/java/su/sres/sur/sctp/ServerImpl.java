...
public class ServerImpl implements Server {
	...
	protected void stop() throws Exception {
		...
		ListIterator<String> iter = associations.listIterator();
		while(iter.hasNext()) {
		    String assocName = iter.next();
	...
	private void initSocket() throws IOException {
		...
		FastTable<ChangeRequest> pendingChanges = this.management.getPendingChanges();
	...
	public String toString() {
        ...
        ListIterator<String> iter = this.associations.listIterator();
        while(iter.hasNext()) {
            sb.append(iter.next());
		sb.append(", ");
        }
	 ...
	 */
	protected static final XMLFormat<ServerImpl> SERVER_XML = new XMLFormat<ServerImpl>() {

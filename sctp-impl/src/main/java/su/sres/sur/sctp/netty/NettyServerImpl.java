...
public class NettyServerImpl implements Server {
    ...
    protected FastTable<String> associations = new FastTable<String>();
    protected FastTable<Association> anonymAssociations = new FastTable<Association>();
     ...
     * (non-Javadoc)
     * 
     * @see su.sres.sur.sctp.api.Server#getIpChannelType()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see su.sres.sur.sctp.api.Server#isAcceptAnonymousConnections()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see su.sres.sur.sctp.api.Server#getMaxConcurrentConnectionsCount()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see su.sres.sur.sctp.api.Server#setMaxConcurrentConnectionsCount(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see su.sres.sur.sctp.api.Server#getName()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see su.sres.sur.sctp.api.Server#getHostAddress()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see su.sres.sur.sctp.api.Server#getHostport()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see su.sres.sur.sctp.api.Server#getExtraHostAddresses()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see su.sres.sur.sctp.api.Server#isStarted()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see su.sres.sur.sctp.api.Server#getAssociations()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see su.sres.sur.sctp.api.Server#getAnonymAssociations()
     */
    @Override
    ...
    protected void stop() throws Exception {
        FastTable<String> tempAssociations = associations;
        ListIterator<String> iterator = tempAssociations.listIterator();
        while (iterator.hasNext()) {
            Association associationTemp = this.management.getAssociation(iterator.next());
...
/*        for (FastTable.Node<String> n = tempAssociations.head(), end = tempAssociations.tail(); (n = n.getNext()) != end;) {
    ...
    public String toString() {
        ...
        ListIterator<String> iterator = this.associations.listIterator();
        while (iterator.hasNext()) {
...
/*        for (FastTable.Node<String> n = this.associations.head(), end = this.associations.tail(); (n = n.getNext()) != end;) {
    ...
    protected static final XMLFormat<NettyServerImpl> SERVER_XML = new XMLFormat<NettyServerImpl>() {
        ...
        public void read(javolution.xml.XMLFormat.InputElement xml, NettyServerImpl server) throws XMLStreamException {
            ...
            server.associations = xml.get(ASSOCIATIONS, FastTable.class);
        }
        ...
        public void write(NettyServerImpl server, javolution.xml.XMLFormat.OutputElement xml) throws XMLStreamException {
            ...
            xml.add(server.associations, ASSOCIATIONS, FastTable.class);
        }
    };
}
